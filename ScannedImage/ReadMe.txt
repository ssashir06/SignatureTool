========================================================================
    ダイナミック リンク ライブラリ: ScannedImage プロジェクトの概要
========================================================================

この ScannedImage DLL は、AppWizard により作成されました。

このファイルには、ScannedImage アプリケーションを構成する各ファイルの内容の概要が含まれています。

ScannedImage.vcxproj
